...
a:
	...
	int dir=0, up = -1, down = -2, left = -3, right = -4; //assign directional variables
	...
	system("color 0A"); //text and output secreen colour
	...
	{ //while start
		...
		cout << "Pacman implementado en C++" << endl;

		gotoxy(40, 19);

		cout << "Nailea Montero y Wendy Balderrama" << endl;   //out of control of position of pacman
